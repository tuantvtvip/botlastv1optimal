...
module.exports.config = {
    ...
    version: "1.2.0",
    hasPermssion: 0,
    credits: "D-Jukie fix data by Lê Định",
...
module.exports.handleReply = async function ({
    ...
    case "choosee": {
        ...
        case "2": {
            ...
            const res = await axios.get(`https://raw.githubusercontent.com/LeDingg/ledingg-/main/dhbc2.json`);
        ...
        case "1": {
            api.unsendMessage(handleReply.messageID);
            const res = await axios.get(`https://raw.githubusercontent.com/LeDingg/ledingg-/main/dhbc.json`);
...
module.exports.run = async function ({
    ...
    if ((this.config.credits) != "D-Jukie fix data by Lê Định") { return api.sendMessage(`⚡️Phát hiện credits đã bị thay đổi`, event.threadID, event.messageID)}
    if (!args[0]) {
