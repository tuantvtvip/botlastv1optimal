...
module.exports.run = async ({
  ...
  if (args.length == 0) return api.sendMessage(`Bạn có thể dùng:\ninfo emoji [icon]\n\ninfo name [tên box cần đổi]\n\nInfo setname => đổi tên nhóm\n\ninfo image [rep một ảnh bất kì cần đặt thành ảnh box]\n\ninfo admin [tag] => nó sẽ đưa qtv cho người được tag\n\ninfo box => Toàn bộ thông tin của nhóm !`, event.threadID, event.messageID);
