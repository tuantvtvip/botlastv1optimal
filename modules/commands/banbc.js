...
module.exports.run = async function({ api, event, args, Threads, Users, Currencies }) {
  try {
    ...
    if (args[0] == 'create' || args[0] == 'new' || args[0] == '-c') {
      ...
      global.baucuaS.set(threadID, gameThread);
      return api.sendMessage({body: "◆𝗧𝗥𝗢̀ 𝗖𝗛𝗢̛𝗜 𝗕𝗔̆́𝗧 𝗗𝗔̂̀𝗨◆\n\n「 𝗫𝗶𝗻 𝗺𝗼̛̀𝗶 " + gameThread.player.length + " 𝗰𝗼𝗻 𝘇𝗼̛̣ 𝗻𝗴𝗵𝗶𝗲̣̂𝗻 𝗻𝗴𝗮̣̂𝗽 𝗰𝘂̉𝗮 𝗺𝗶̣ 𝗱𝗮̣̆𝘁 𝗰𝘂̛̉𝗮 𝗕𝗔̂̀𝗨,𝗖𝗨𝗔,𝗧𝗢̂𝗠,𝗖𝗔́,𝗡𝗔𝗜 𝗵𝗼𝗮̣̆𝗰 𝗚𝗔̀ 」",attachment: createReadStream(__dirname + "/trogiup/menu/ducryo.jpg")},threadID, messageID);
    }
