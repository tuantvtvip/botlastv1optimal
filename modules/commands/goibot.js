...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "anh tuân") || (event.body.toLowerCase() == "anh dang")) {
  ...
  if ((event.body.toLowerCase() == "bot sinh năm bao nhiêu") || (event.body.toLowerCase() == "bot 2k mấy")) {
    return api.sendMessage("Em sinh năm 2022 do admin tuantvt🦋 tạo ra", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "@Overnine Houtarou") || (event.body.toLowerCase() == "@Dii TaeKook")) {
    return api.sendMessage("Ai kêu chủ tao đấy, mà làm ơn đừng tag bé ấy mà hãy liên hệ qua Fb: fb.me/100073862257362", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "yêu bot") || (event.body.toLowerCase() == "yeu bot")) {
   ...
   if ((event.body.toLowerCase() == "yêu anh") || (event.body.toLowerCase() == "yeu anh")) {
    return api.sendMessage("Anh cũng không yêu em!", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "admin mày là ai vậy bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao là tuantvt vippro có gì dùng lệnh /ad để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "tuân ơi") || (event.body.toLowerCase() == "tuân oiiii")) {
    return api.sendMessage("️ Gì mà réo lắm thế? Từ từ admin tôi vào.", threadID);
  };

  if ((event.body.toLowerCase() == "tuân") || (event.body.toLowerCase() == "dang")) {
