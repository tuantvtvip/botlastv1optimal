...
module.exports.run = async({ api,
    ...
    const atm = await type == "𝐦𝐞𝐬𝐬𝐚𝐠𝐞_𝐫𝐞𝐩𝐥𝐲" ? mR.attachments : atms.length != 0 ? atms : "nofile";
    const content = !args[1] ? "𝐜𝐡𝐢̉ 𝐜𝐨́ 𝐭𝐞̣̂𝐩" : body.slice(body.indexOf(args[1]));
    if (!args[1] && atm == "nofile") return api.sendMessage(`‼️ Bạn chưa nhập nội dung`, tid, mid);
    var msg = `»𝐒𝐄𝐍𝐃𝐍𝐎𝐓𝐈« \n⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻ \n🔮 𝙽𝙾̛𝙸 𝙶𝚄̛̉𝙸  ➣ ${event.isGroup == true ? '𝐧𝐡𝐨́𝐦 ' + global.data.threadInfo.get(event.threadID).threadName: '𝐜𝐡𝐚𝐭 𝐫𝐢𝐞̂𝐧𝐠 𝐯𝐨̛́𝐢 𝐛𝐨𝐭'}\n→ 𝙽𝚊𝚖𝚎  ➣ ${(await Users.getData(sid)).name}
𝗧𝗶𝗺𝗲  ➣ ${fullTime()}
⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻
𝙽𝚘̣̂𝚒 𝚍𝚞𝚗𝚐  ➣ ${content}\n⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻
🎭𝚁𝚎𝚙𝚕𝚢 𝚝𝚒𝚗 𝚗𝚑𝚊̆́𝚗 𝚗𝚊̀𝚢 đ𝚎̂̉ 𝚙𝚑𝚊̉𝚗 𝚑𝚘̂̀𝚒 𝚟𝚎̂̀ 𝙰𝙳𝙼𝙸𝙽🎭\n 𝚄𝙸𝙳  ➣  facebook.com/${event.senderID} \n⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻⫻`
